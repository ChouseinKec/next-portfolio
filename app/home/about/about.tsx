            ...
            <div className={styles.text}>
                ...
                <p>
                    <span>
                        ...
                        While I do not consider myself expert in all these areas, I am primarily self-taught and continually dedicate my free time to research, learn and build new things.
                    </span>
                </p>
            </div>
        </section>
